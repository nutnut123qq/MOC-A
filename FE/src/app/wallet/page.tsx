  ...
  return (
    <div className="min-h-screen pt-20" style={{backgroundColor: '#fcf8ef'}}>
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        {/* Balance Card */}
        <div className="rounded-xl p-6 text-white shadow-lg" style={{background: `linear-gradient(to right, #dc2626, #E21C34)`}}>
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold mb-2">Ví của tôi</h2>
              <p className="text-4xl font-bold">{balance.toLocaleString()} VND</p>
              <p className="text-red-100 mt-2">Số dư khả dụng</p>
            </div>
          ...
          <div className="flex gap-4 mt-6">
            ...
            >
              <ArrowUpIcon className="w-5 h-5" style={{color: 'white'}} />
              <span style={{color: 'white', fontWeight: '500'}}>Nạp tiền</span>
            </button>
            <button
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {loadingTransactions ? (
            <div className="text-center py-8">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 mx-auto" style={{borderColor: '#E21C34'}}></div>
