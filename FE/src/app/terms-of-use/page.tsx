              ...
              <div className="bg-amber-50 rounded-lg p-6">
                <div className="space-y-4 text-gray-700">
                  ...
                  <p className="flex items-start">
                    ...
                    <span>
                      <span style={{whiteSpace: 'nowrap'}}><strong>"Á! Studio"</strong> không</span> nhận đổi trả với sản phẩm đã in theo thiết kế riêng, trừ khi lỗi do kỹ thuật in hoặc hư hỏng trong quá trình vận chuyển (vui lòng quay video khi nhận/mở hàng).
                    </span>
                  </p>
                  <p className="flex items-start">
                    <svg className="w-5 h-5 text-blue-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span>
                      Á! Studio chỉ giải quyết đổi trả hàng trong <span style={{whiteSpace: 'nowrap'}}>vòng <strong>7 ngày</strong> kể</span> từ ngày nhận hàng.
                    </span>
                  </p>
                </div>
              </div>
